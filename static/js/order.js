...
// Check on page load. If the user has scanned a QR-code the table number field should show.
...
function tableNumberShow(){
    /**
     * When this function is run the table number field will show and be required
     */
...
function tableNumberHide(){
    /**
     * When this function is run the table number field will be hidden and not required
     */
